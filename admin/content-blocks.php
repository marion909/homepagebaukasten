            ...
            <tbody>
                <?php foreach ($blocks as $block): ?>
                    <tr>
                        ...
                        <td>
                            <span class="status status-<?= htmlspecialchars($block['type'] ?? 'html') ?>"><?= ucfirst($block['type'] ?? 'html') ?></span>
                        </td>
                        <td>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="type" name="type" required>
                        <option value="text" <?= ($blockData['type'] ?? '') === 'text' ? 'selected' : '' ?>>Text</option>
                        <option value="html" <?= ($blockData['type'] ?? '') === 'html' ? 'selected' : '' ?>>HTML</option>
                    </select>
                </div>
            </div>
